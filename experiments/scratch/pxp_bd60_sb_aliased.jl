...
#   julia --project=. experiments/run_group.jl pxp_bd60
#
#   julia --project=. experiments/pxp_bd60_sb_aliased.jl [seed]

include(joinpath(@__DIR__, "bench_common.jl"))

run_config("pxp_bd60", :sb_aliased;
