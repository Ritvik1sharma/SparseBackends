...
#   julia --project=. experiments/run_group.jl pxp_bd20
#
#   julia --project=. experiments/pxp_bd20_sb_aliased.jl [seed]

include(joinpath(@__DIR__, "bench_common.jl"))

run_config("pxp_bd20", :sb_aliased;
