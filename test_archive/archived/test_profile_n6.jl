...
let
    ...
    # === Phase 2: PROFILE 6 production-regime single sweeps. Track GC stats. ===
    println("\n=== PROFILE (6 sweeps at maxdim=40, per-sweep GC stats) ===")
    ...
    println("\n========== ITensorMPS.PROJMPO_TIMER (cumulative over 6 sweeps) ==========")
    print_timer(ITensorMPS.PROJMPO_TIMER)
    println("\n========== SparseBackends.TIMER (cumulative over 6 sweeps) ==========")
